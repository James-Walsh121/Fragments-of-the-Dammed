...
Car::Car(std::string n)
{
	...
	if (filename == "P1Idle.png")
	{
		...
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec1_1.png", cocos2d::Rect(0, 0, 120, 80)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec1_2.png", cocos2d::Rect(0, 0, 120, 80)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec1_3.png", cocos2d::Rect(0, 0, 120, 80)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec1_4.png", cocos2d::Rect(-30, -20, 120, 80)));

		special2Anim.reserve(3);
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec2_1.png", cocos2d::Rect(0, 0, 120, 80)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec2_2.png", cocos2d::Rect(0, 0, 120, 80)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec2_3.png", cocos2d::Rect(-30, -20, 120, 80)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P1Spec2_4.png", cocos2d::Rect(-30, -20, 120, 80)));
	}
	else if (filename == "P2Idle.png")
	{
		...
		special1Anim.reserve(3);
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec1.png", cocos2d::Rect(0, 0, 250, 41)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec2.png", cocos2d::Rect(0, 0, 250, 41)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec3.png", cocos2d::Rect(0, 0, 250, 41)));

		special2Anim.reserve(3);
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec2_1.png", cocos2d::Rect(0, 0, 250, 41)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec2_2.png", cocos2d::Rect(0, 0, 250, 41)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P2Spec2_3.png", cocos2d::Rect(0, 0, 250, 41)));
	...
	else if (filename == "P3Idle.png")
	{
		...
		special1Anim.reserve(3);
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec1.png", cocos2d::Rect(0, 0, 250, 41)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec2.png", cocos2d::Rect(0, 0, 250, 41)));
		special1Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec3.png", cocos2d::Rect(0, 0, 250, 41)));

		special2Anim.reserve(3);
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec2_1.png", cocos2d::Rect(0, 0, 250, 41)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec2_2.png", cocos2d::Rect(0, 0, 250, 41)));
		special2Anim.pushBack(cocos2d::SpriteFrame::create("P3Spec2_3.png", cocos2d::Rect(0, 0, 250, 41)));
